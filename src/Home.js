...
const Home = () => {
	const projects = [
		{
			title: "NYC SuperBNB",
			description: "Users search Airbnbs by neighborhood with convex shape boundary detection",
		...
		{
			title: "Minesweeper",
			description: "Replicated minesweeper, adding debug mode, tile/mine count selection",
		...
		{
			title: "Clubfinity",
			description: "Led team of 5 working on Software Engineering Club's App, Clubfinity",
		...
		},
		{
			...
			description: "TGA Image Editing app with C++; added filters like overlay and blur",
		...
		{
			title: "Blog",
			description: "Created a blog website with ability to write + delete blogs stored in backend",
